...
export default function Competitions() {
  ...
  function getCompletionStatus(challenge) {
    ...
    // Show 'points added' if completed, else 'pending trainer approval'
    return joined.completed ? "pointsAdded" : "pendingApproval";
  }
      ...
      >
        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          <div className="mt-4 flex justify-between items-center">
            {isJoined ? (
              completionStatus === "pointsAdded" ? (
                <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full bg-green-100 text-green-700">
                  <CheckCircle size={14} /> Points Added
                </span>
              ) : (
